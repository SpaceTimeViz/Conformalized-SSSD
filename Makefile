...
install-dev:
	...
	@$(SHELL) envs/conda/build_conda_env.sh -c imputer

## Run tests
test:
	@echo "Running tests..."
	@$(EXECUTABLE) pytest --cov=imputer
...
build-docker:
	...
	@docker build -t $(DOCKER_USERNAME)/imputer:latest -f Dockerfile .

push-docker:
	@echo "Pushing Docker image to Docker Hub..."
	@docker push $(DOCKER_USERNAME)/imputer:latest
